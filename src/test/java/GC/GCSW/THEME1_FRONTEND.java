...
public class THEME1_FRONTEND {
	@Test
	public void Theme1_Frontend() throws InterruptedException {
		ChromeOptions op = new ChromeOptions();
		op.addArguments("--remote-allow-origins=*");
		op.addArguments("incognito");
		ChromeDriver driver1 = new ChromeDriver(op);
		driver1.manage().window().maximize();
		driver1.get("https://www.givecentral.org/appeals-form-registration/acp67189adcdafe0/user/guest");
